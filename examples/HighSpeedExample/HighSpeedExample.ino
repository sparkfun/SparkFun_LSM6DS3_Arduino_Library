...
Example using the LSM6DS3 with single channel with a 'tuned' configuration
...
void setup( void ) {
  ...
  mySensor.settings.gyroEnabled = 0;  //Can be 0 or 1
  ...
  mySensor.settings.accelRange = 4;      //Max G force readable.  Can be: 2, 4, 8, 16
  mySensor.settings.accelSampleRate = 1666;  //Hz.  Can be: 13, 26, 52, 104, 208, 416, 833, 1666, 3332, 6664, 13330
